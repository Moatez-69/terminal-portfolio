export default function AboutPage() {
  const skills = {
    ...
    "Web Technologies": ["HTML", "CSS", "JavaScript", "React.js", "Node.js", "Next.js", "Tailwind CSS"],
    ...
    "Tools & Technologies": ["SQL", "MySQL", "PostgreSQL", "PL/SQL", "Docker", "Prisma ORM", "Elasticsearch"],
    "DevOps & Deployment": [
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <section className="mb-12">
        <div className="border terminal:border-terminal-accent light:border-gray-300 rounded-lg p-6 terminal:bg-terminal-accent/5 light:bg-gray-50">
          <div className="font-mono terminal:text-terminal-text light:text-light-text space-y-4">
            ...
            <p className="leading-relaxed">
              ...
              , Master student in Cybersecurity with a background in software engineering, CTF competitions, and Python
              automation. Awarded an Excellence Scholarship at MedTech University.
            </p>
            <p className="leading-relaxed">
              Proven ability to develop secure systems, create custom tooling, and contribute to high-performing teams.
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          {experience.map((exp, index) => (
            <div key={index} className="border terminal:border-terminal-accent/30 light:border-gray-300 rounded-lg p-4">
              <div className="flex items-start justify-between mb-2">
                <div>
                  <h3 className="font-bold terminal:text-terminal-text light:text-light-text font-mono">{exp.title}</h3>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {Object.entries(skills).map(([category, items]) => (
            <div
              key={category}
              className="border terminal:border-terminal-accent/30 light:border-gray-300 rounded-lg p-4"
            >
              <h3 className="font-bold terminal:text-terminal-text light:text-light-text font-mono mb-3">{category}</h3>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border terminal:border-terminal-accent/30 light:border-gray-300 rounded-lg p-4 text-center">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a
            ...
            className="flex items-center gap-3 p-4 border terminal:border-terminal-accent/30 light:border-gray-300 rounded terminal:hover:border-terminal-accent light:hover:border-gray-400 transition-all duration-200"
          >
          ...
          <div className="flex items-center gap-3 p-4 border terminal:border-terminal-accent/30 light:border-gray-300 rounded">
            <span className="text-2xl">📍</span>
            <div className="font-mono">
