          ...
          {projects
            ...
            .map((project, index) => (
              ...
              >
                ...
                <p className="terminal:text-terminal-text light:text-light-text opacity-80 mb-4 leading-relaxed">
                  {project.description}
                </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          {projects.map((project, index) => (
            <div
              key={index}
              className="border terminal:border-terminal-accent/30 light:border-gray-300 rounded p-4 terminal:hover:border-terminal-accent light:hover:border-gray-400 transition-all duration-200"
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    {project.technologies.slice(0, 3).map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="terminal:text-terminal-accent light:text-light-accent opacity-80"
                      >
                        {tech}
                      </span>
                    ))}
